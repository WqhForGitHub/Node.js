...
const products = {
  p001: {
    ...
    price: 2999,
    originalPrice: 3999,
    description: '旗舰级智能手机，支持5G网络，超强拍照',
    images: ['/img/p001_1.jpg', '/img/p001_2.jpg'],
    specs: {
      screen: '6.7英寸',
      cpu: 'A17 Pro',
      ram: '8GB',
  ...
  p002: {
    ...
    price: 5999,
    originalPrice: 6999,
    description: '超轻薄设计，长续航，高性能办公',
    images: ['/img/p002_1.jpg', '/img/p002_2.jpg'],
    specs: {
      screen: '14英寸',
      cpu: 'M3',
      ram: '16GB',
  ...
  p003: {
    ...
    price: 199,
    originalPrice: 299,
    description: '主动降噪，高清音质，30小时续航',
    images: ['/img/p003_1.jpg'],
    specs: {
      driver: '11mm',
      battery: '30小时',
      noise: 'ANC主动降噪',
  ...
  p004: {
    ...
    price: 99,
    originalPrice: 129,
    description: '防摔防震，轻薄透明设计',
    images: ['/img/p004_1.jpg'],
    specs: {
      material: 'TPU+PC',
      weight: '30g',
      compatible: '智能手机 Pro Max',
    },
    rating: 4.2,
    reviewCount: 5678,
    tags: ['配件', '防摔'],
  ...
  p005: {
    ...
    price: 399,
    originalPrice: 499,
    description: '20000mAh大容量，支持65W快充',
    images: ['/img/p005_1.jpg'],
    specs: {
      capacity: '20000mAh',
      output: '65W',
  ...
  p006: {
    ...
    images: ['/img/p006_1.jpg', '/img/p006_2.jpg'],
    specs: {
      screen: '1.43英寸AMOLED',
      battery: '14天',
      waterproof: '5ATM',
...
const server = http.createServer(async (req, res) => {
  ...
  if (method === 'GET' && path === '/products') {
    ...
    if (keyword)
      result = result.filter((p) => p.name.includes(keyword) || p.description.includes(keyword));
    return json(res, 200, {
      success: true,
      data: result,
      total: result.length,
