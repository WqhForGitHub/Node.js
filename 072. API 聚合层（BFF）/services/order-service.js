...
const orders = {
  o001: {
    ...
    items: [
      ...
      { productId: "p003", quantity: 1, price: 199 },
    ],
    totalAmount: 6197,
    status: "completed",
    createdAt: "2024-10-01T10:30:00Z",
    paidAt: "2024-10-01T10:35:00Z",
    shippedAt: "2024-10-02T09:00:00Z",
    address: "北京市朝阳区xxx路",
  },
  o002: {
    id: "o002",
    userId: "u001",
    items: [{ productId: "p002", quantity: 1, price: 5999 }],
    totalAmount: 5999,
    status: "shipped",
    createdAt: "2024-10-15T14:20:00Z",
    paidAt: "2024-10-15T14:25:00Z",
    shippedAt: "2024-10-16T08:30:00Z",
    address: "北京市朝阳区xxx路",
  },
  o003: {
    id: "o003",
    userId: "u002",
    items: [
      { productId: "p001", quantity: 1, price: 2999 },
      { productId: "p004", quantity: 3, price: 99 },
    ],
    totalAmount: 3296,
    status: "paid",
    createdAt: "2024-11-01T09:10:00Z",
    paidAt: "2024-11-01T09:15:00Z",
    address: "上海市浦东新区xxx街",
  },
  o004: {
    id: "o004",
    userId: "u003",
    items: [{ productId: "p002", quantity: 2, price: 5999 }],
    totalAmount: 11998,
    status: "pending",
  ...
  o005: {
    id: "o005",
    userId: "u001",
    items: [{ productId: "p005", quantity: 1, price: 399 }],
    totalAmount: 399,
    status: "cancelled",
    createdAt: "2024-09-10T11:00:00Z",
    cancelledAt: "2024-09-10T15:30:00Z",
    cancelReason: "不想要了",
    address: "北京市朝阳区xxx路",
  },
  o006: {
    ...
    userId: "u002",
    items: [
      { productId: "p003", quantity: 5, price: 199 },
      { productId: "p004", quantity: 10, price: 99 },
    ],
    totalAmount: 1985,
    status: "completed",
    createdAt: "2024-08-05T08:00:00Z",
    paidAt: "2024-08-05T08:05:00Z",
    shippedAt: "2024-08-06T10:00:00Z",
    address: "上海市浦东新区xxx街",
  },
};
...
const server = http.createServer(async (req, res) => {
  ...
  if (method === "PUT" && path.startsWith("/orders/")) {
    const orderId = path.split("/")[2];
    if (!orders[orderId])
      return json(res, 404, { success: false, error: "订单不存在" });
    const body = await parseBody(req);
